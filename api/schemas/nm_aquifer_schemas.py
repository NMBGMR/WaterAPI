...
#     PointID: str
#     OBJECTID: int
#     DepthToWaterBGS: Optional[float]
#     measurement_method_meaning: Optional[str] = Field(alias="MeasurementMethodMeaning")
#
#     DateTimeMeasured: Optional[datetime]
#
#
# class WaterLevels(WaterLevelsBase):
#     DepthToWater: Optional[float]
