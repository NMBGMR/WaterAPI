...
Revision ID: 6e8a1930cea9
Revises: 
Create Date: 2022-11-22 18:51:09.796903
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_LU_AquiferClass_id"), "LU_AquiferClass", ["id"], unique=False
    )
    op.create_table(
        "LU_AquiferType",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_LU_AquiferType_id"), "LU_AquiferType", ["id"], unique=False
    )
    op.create_table(
        "LU_CurrentUse",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_LU_MeasurementMethod_id"), "LU_MeasurementMethod", ["id"], unique=False
    )
    op.create_table(
        "LU_Status",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_ProjectLocation_id"), "ProjectLocation", ["id"], unique=False
    )
    op.create_table(
        "Thing",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(op.f("ix_Thing_id"), "Thing", ["id"], unique=False)
    op.create_table(
        "Measurement",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(op.f("ix_Surface_id"), "Surface", ["id"], unique=False)
    op.create_table(
        "ThingFile",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(op.f("ix_ThingFile_id"), "ThingFile", ["id"], unique=False)
    op.create_table(
        "Well",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column("thing_id", sa.Integer(), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_table("Well")
    op.drop_index(op.f("ix_ThingFile_id"), table_name="ThingFile")
    op.drop_table("ThingFile")
    ...
    op.drop_index(op.f("ix_Thing_id"), table_name="Thing")
    op.drop_table("Thing")
